...
visitor_t::visitor_t (world_t *in_world, string in_path, string visiting_path, bool looped_path, float in_speed, float in_wait_time, float in_size, bool in_animated, float fps, unsigned frames, bool skeletal, glm::vec3 in_T, glm::vec3 in_R, glm::vec3 in_S)
