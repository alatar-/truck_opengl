...
void TestRectangle::setUp(void) {
    ...
    r_pos_10 = new Rectangle(
        vertex_2d( -25.845991 , -111.946411 ) 
    ,   vertex_2d( -25.845991 , 73.699738 ) 
    ,   vertex_2d( -24.449694 , -111.946411 )
    ,   vertex_2d( -24.449694 , 73.699738 ) 
    );

    r_pos_11 = new Rectangle(
        vertex_2d( -3.107260 , -9.625175 ) 
    ,   vertex_2d( -2.534225 , 9.438456 ) 
    ,   vertex_2d( 2.507745 , -9.793956 )
    ,   vertex_2d( 3.080779 , 9.269674 ) 
    );
    ...
    r_pos_13 = new Rectangle(
        vertex_2d( -4.156987 , 8.896313 ) 
    ,   vertex_2d( -11.341509 , 31.071060 ) 
    ,   vertex_2d( -6.460926 , 32.652348 ) 
    ,   vertex_2d( 0.723597 , 10.477601 ) 
    );
    ...
    r_pos_15 = new Rectangle(
        vertex_2d( -9.439823 , -37.969597 ) 
    ,   vertex_2d( -24.506420 , -20.190165 ) 
    ,   vertex_2d( -5.602348 , -34.717651 ) 
    ,   vertex_2d( -20.668945 , -16.938221 ) 
    );
